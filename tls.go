...
func configureClientCertificates(httpBinding HTTPBinding, server *http.Server) (err error) {
...
func configureServerCertificates(httpBinding HTTPBinding, server *http.Server) (err error) {
